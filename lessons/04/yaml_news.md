...
You can access items in a list (array) via the [Liquid templating language](http://liquidmarkup.org/) that is used by [Jekyll](https://jekyllrb.com/docs/templates/).
